...
class PlnMainFragment : Fragment(), View.OnClickListener {
    ...
    private val plnViewModel: PlnViewModel by viewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            cameraBtn.setOnClickListener(this@PlnMainFragment)
            btnSubmit.setOnClickListener(this@PlnMainFragment)
        }
    }
    ...
    private fun onSubmit() {
        ...
        plnViewModel.checkIsFakeFromURI(body, requireContext()).observe(viewLifecycleOwner) {
            val usage = usage
            val bundle = Bundle()
            bundle.apply {
                putString(SERVICE_TYPE, PLN)
